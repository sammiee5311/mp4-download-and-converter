...
from main import download_videos, convert_videos, download_and_covert_from_url_argument, download_and_covert
from helper import get_all_video_urls_from_text_file
from tests.conftest import get_test_files, get_download_files, get_converted_files, convert_mp4_to_mp3
...
def test_convert() -> None:
    downloaded_files = get_download_files()
    converted_files = []
    ...
    test_converted_files = [file.split("/")[-1] for file in get_converted_files()]
